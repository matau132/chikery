      ...
      <div class="header__center">
        <nav class="header__navigation left">
          <ul class="menu">
            ...
            <li class="menu-item-has-children"><a href="shop-default.html">Shop</a><span class="sub-toggle"><i class="fa fa-angle-down"></i></span>
              <ul class="sub-menu">
        ...
        <nav class="header__navigation right">
          <ul class="menu">
            <li class="menu-item-has-children"><a href="about-us.html">Pages</a><span class="sub-toggle"><i class="fa fa-angle-down"></i></span>
              <ul class="sub-menu">
                <li class="current-menu-item "><a href="about-us.html">About</a>
                </li>
            ...
            <li class="menu-item-has-children"><a href="blog-grid.html">News</a><span class="sub-toggle"><i class="fa fa-angle-down"></i></span>
              <ul class="sub-menu">
                <li class="current-menu-item "><a href="blog-grid.html">Blog grid</a>
                </li>
                <li class="current-menu-item "><a href="blog-grid-fullwidth.html">Blog grid fullwidth</a>
                </li>
      ...
      <div class="ps-hero bg--cover" data-background="img/hero/shop-hero.png">
        <div class="ps-hero__container">
          ...
          <div class="ps-post--detail-header">
            <h1>Mauris elementum accumsan <br/> leo vel tempor</h1>
            <div class="ps-post__meta"><span>Food</span><span>March 31, 2019  by <a href="#">Admin</a></span></div>
          </div>
        </div>
      </div>
      <div class="ps-hero--blog"><img src="img/blog/blog-detail.jpg" alt=""></div>
      <div class="container">
        <div class="ps-blog ps-blog--sidebar">
          <div class="ps-blog__left">
            <div class="ps-post--detail">
              <div class="ps-post__content">
                <p><strong class="large">Class aptent taciti sociosqu ad litora torquent per. Conubia vitae viverra urna nulla sed turpis .Mauris elementum accumsan leo vel tempor</strong></p>
                ...
                <p>Suspendisse faucibus sed dolor eget posuere.Sed id interdum urna. Nam ac elit a ante commodo tristique. Duis lacus urna, condimentum a vehicula a, hendrerit ac nisi Lorem ipsum dolor sit amet.Vestibulum imperdiet nibh vel magna lacinia ultrices. Sed id interdum urna. Nam ac elit a ante commodo tristique. Duis lacus urna, condimentum a vehicula a, hendrerit ac nisi Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                <div class="ps-post__tags"><span>Tags</span><a href="#">Branding</a><a href="#">Interior</a><a href="#">Bakery</a></div>
              </div>
            </div>
            <div class="ps-blog-comments">
              <h3>Comments <span>(02)</span></h3>
              <div class="ps-comment-box">
                <div class="ps-block--comment">
                  <div class="ps-block__thumbnail"><img src="img/blog/blog-comment/user-1.jpg" alt=""></div>
                  <div class="ps-block__content">
                    <div class="ps-block__header">
                      <h4>Kavin smith<span>March 31, 2019</span></h4>
                    </div>
                    <p>Nam ac elit a ante commodo tristique. Duis lacus urna, condimentum a vehicula a, hendrerit ac nisi Lorem ipsum dolor sit amet, consectetur adipiscing elit. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                  </div>
                </div>
                <div class="ps-block--comment">
                  <div class="ps-block__thumbnail"><img src="img/blog/blog-comment/user-2.jpg" alt=""></div>
                  <div class="ps-block__content">
                    <div class="ps-block__header">
                      <h4>Kavin smith<span>March 31, 2019</span></h4>
                    </div>
              ...
              <form class="ps-form--leave-a-comment" action="http://nouthemes.net/html/chikery/index.html" method="post">
                ...
                <div class="ps-form__submit">
                  <button class="ps-btn">Post</button>
                </div>
              </form>
            </div>
          </div>
          <div class="ps-blog__right">
            <aside class="widget widget_search">
              <form class="ps-form--widget-search" action="http://nouthemes.net/html/chikery/index.html" method="post">
            ...
            <aside class="widget widget_blog widget_recent-posts">
              ...
              <div class="ps-post--sidebar">
                <div class="ps-post__thumbnail"><a class="ps-post__overlay" href="blog-detail.html"></a><img src="img/blog/blog-sidebar/1.jpg" alt=""></div>
                <div class="ps-post__content"><a class="ps-post__title" href="blog-detail.html">Nam ac elit a ante commodo</a>
                  <p>By<a href="#"> Admin</a></p>
                </div>
              </div>
              <div class="ps-post--sidebar">
                <div class="ps-post__thumbnail"><a class="ps-post__overlay" href="blog-detail.html"></a><img src="img/blog/blog-sidebar/2.jpg" alt=""></div>
                <div class="ps-post__content"><a class="ps-post__title" href="blog-detail.html">Nam ac elit a ante commodo</a>
                  <p>By<a href="#"> Admin</a></p>
                </div>
              </div>
              <div class="ps-post--sidebar">
                <div class="ps-post__thumbnail"><a class="ps-post__overlay" href="blog-detail.html"></a><img src="img/blog/blog-sidebar/3.jpg" alt=""></div>
                <div class="ps-post__content"><a class="ps-post__title" href="blog-detail.html">Nam ac elit a ante commodo</a>
                  <p>By<a href="#"> Admin</a></p>
                </div>
              </div>
              <div class="ps-post--sidebar">
                <div class="ps-post__thumbnail"><a class="ps-post__overlay" href="blog-detail.html"></a><img src="img/blog/blog-sidebar/4.jpg" alt=""></div>
                <div class="ps-post__content"><a class="ps-post__title" href="blog-detail.html">Nam ac elit a ante commodo</a>
                  <p>By<a href="#"> Admin</a></p>
                </div>
              </div>
    ...
    <footer class="ps-footer">
      <div class="ps-footer__content">
        <div class="container">
          ...
          <div class="ps-footer__center">
            <div class="ps-site-info"><a class="ps-logo" href="index-2.html"><img src="img/logo.png" alt=""></a>
              <p>004 Riley Street, Surry Hills 2050 Sydney, Australia</p>
              <p>Email:<a href="#"> <span class="__cf_email__" data-cfemail="c6afa8a0a986a8a9b3b2aea3aba3b5e8a5a9ab">[email&#160;protected]</span></a></p>
      ...
      <div class="ps-footer__bottom">
        <div class="container">
          ...
          <p>© 2019 Chikery.  Made by<a href="index-2.html"> Nouthemes</a></p>
        </div>
      </div>
    </footer>
