          ...
          <div class="row">
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-6 ">
              <div class="ps-product">
                <div class="ps-product__thumbnail text-center"><img src="{{url('public/uploads/product')}}/{{$models->image}}" class="img-fluid max-width: 100% height:auto" alt="" width="300px"/><a class="ps-product__overlay" href="product-default.html" ></a><span class="ps-badge ps-badge--sale"><i>30%</i></span>
                </div>
